...
const Home = () => {
  ...
  return <main className="flex flex-1 mx-auto w-full min-w-0">
      <div className="flex flex-col w-full flex-1">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 py-12 sm:py-16 md:py-20">
            <div className="max-w-4xl mx-auto text-center md:text-left md:mx-0">
              ...
              <div className="mb-4 sm:mb-6 inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-primary/10 border border-primary/20 backdrop-blur-sm">
                ...
                <span className="text-xs sm:text-sm font-medium text-primary">Mais de 25 anos de excelência</span>
              </div>
              
              <h1 className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black leading-tight tracking-tight mb-4 sm:mb-6 animate-fade-in">
              ...
              <p className="text-base sm:text-lg md:text-xl text-muted-foreground mb-6 sm:mb-8 max-w-2xl mx-auto md:mx-0 leading-relaxed px-2 sm:px-0">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center md:justify-start px-4 sm:px-0">
                <a href="#produtos" className="w-full sm:w-auto">
                  <button className="group w-full sm:w-auto flex items-center justify-center gap-2 min-w-[160px] sm:min-w-[180px] h-12 sm:h-14 px-6 sm:px-8 bg-primary hover:bg-primary/90 text-primary-foreground text-sm sm:text-base font-bold rounded-lg transition-all shadow-lg hover:shadow-primary/30 hover:shadow-xl hover:scale-105">
                ...
                <a href="#sobre" className="w-full sm:w-auto">
                  <button className="w-full sm:w-auto flex items-center justify-center min-w-[160px] sm:min-w-[180px] h-12 sm:h-14 px-6 sm:px-8 bg-card hover:bg-card/80 text-foreground border border-border text-sm sm:text-base font-semibold rounded-lg transition-all hover:scale-105">
                    Sobre Nós
                  </button>
                </a>
              </div>
        ...
        {/* Features Section */}
        <section id="features" className="relative py-12 sm:py-16 md:py-24 px-4 sm:px-6 lg:px-10 scroll-mt-20">
          <div className="absolute inset-0 gradient-radial opacity-50"></div>
          
          <div className="relative z-10 max-w-7xl mx-auto">
            <div className="text-center mb-8 sm:mb-12 md:mb-16">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-black mb-3 sm:mb-4 text-foreground">Por que escolher a MBITTENCOURT?</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
              <div className="group relative p-5 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl bg-card/50 border border-border hover:border-primary/50 transition-all hover:shadow-2xl hover:shadow-primary/10 hover:-translate-y-2">
                ...
                <div className="relative">
                  <div className="flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 rounded-lg sm:rounded-xl bg-primary/10 text-primary mb-4 sm:mb-6 group-hover:scale-110 transition-transform">
                    <Shield size={24} className="sm:hidden" />
                    <Shield size={28} className="hidden sm:block" />
                  </div>
                  <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 text-foreground">Compra 100% Segura</h3>
              ...
              <div className="group relative p-5 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl bg-card/50 border border-border hover:border-primary/50 transition-all hover:shadow-2xl hover:shadow-primary/10 hover:-translate-y-2">
                ...
                <div className="relative">
                  ...
                  <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 text-foreground">Catálogo Completo</h3>
                  <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
              ...
              <div className="group relative p-5 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl bg-card/50 border border-border hover:border-primary/50 transition-all hover:shadow-2xl hover:shadow-primary/10 hover:-translate-y-2 sm:col-span-2 lg:col-span-1">
                <div className="absolute inset-0 bg-gradient-to-br from-primary/5 to-transparent rounded-xl sm:rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity"></div>
                <div className="relative">
                  <div className="flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 rounded-lg sm:rounded-xl bg-primary/10 text-primary mb-4 sm:mb-6 group-hover:scale-110 transition-transform">
                    <TruckIcon size={24} className="sm:hidden" />
                    <TruckIcon size={28} className="hidden sm:block" />
                  </div>
                  <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 text-foreground">Entrega Nacional</h3>
                  <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
        ...
        <section id="sobre" className="relative min-h-[60vh] sm:min-h-[70vh] flex items-center justify-center overflow-hidden scroll-mt-20">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 py-12 sm:py-16 md:py-20">
            <div className="max-w-3xl mx-auto text-center md:text-left md:mx-0">
              <div className="mb-4 sm:mb-6 inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-primary/10 border border-primary/20 backdrop-blur-sm">
                <span className="text-xs sm:text-sm font-medium text-primary">Desde 1996</span>
              </div>
              
              <h2 className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black leading-tight mb-4 sm:mb-6">
        ...
        <section className="py-12 sm:py-16 md:py-24 px-4 sm:px-6 lg:px-10">
          <div className="max-w-7xl mx-auto">
            <div className="mb-12 sm:mb-16 md:mb-24">
              <h2 className="text-xl sm:text-2xl md:text-3xl font-black mb-8 sm:mb-10 md:mb-12 text-foreground text-center md:text-left">Nossa Trajetória</h2>
              
              <div className="relative">
                <div className="absolute left-4 sm:left-6 top-0 bottom-0 w-0.5 bg-gradient-to-b from-primary via-primary/50 to-transparent"></div>
                
                <div className="space-y-6 sm:space-y-8 md:space-y-12">
                  <div className="relative pl-12 sm:pl-16 md:pl-20 group">
                    <div className="absolute left-0 flex items-center justify-center w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-full bg-primary/20 border-2 sm:border-4 border-background ring-2 ring-primary/30 group-hover:scale-110 transition-transform">
                      <Flag size={14} className="text-primary sm:hidden" />
                      <Flag size={16} className="text-primary hidden sm:block md:hidden" />
                      <Flag size={20} className="text-primary hidden md:block" />
                    </div>
                    <div className="p-4 sm:p-5 md:p-6 rounded-lg sm:rounded-xl bg-card/50 border border-border hover:border-primary/50 transition-all">
                      <p className="text-base sm:text-lg md:text-xl font-bold text-foreground mb-1 sm:mb-2">Nascimento da MBITTENCOURT</p>
                      <p className="text-primary font-semibold mb-1 sm:mb-2 text-sm sm:text-base">1996</p>
                      <p className="text-muted-foreground text-sm sm:text-base">Fundação da empresa com foco em suprimentos de informática de alta qualidade.</p>
                    </div>
                  </div>
                  ...
                  <div className="relative pl-12 sm:pl-16 md:pl-20 group">
                    <div className="absolute left-0 flex items-center justify-center w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-full bg-primary/20 border-2 sm:border-4 border-background ring-2 ring-primary/30 group-hover:scale-110 transition-transform">
                      ...
                      <TrendingUp size={16} className="text-primary hidden sm:block md:hidden" />
                      <TrendingUp size={20} className="text-primary hidden md:block" />
                    </div>
                    <div className="p-4 sm:p-5 md:p-6 rounded-lg sm:rounded-xl bg-card/50 border border-border hover:border-primary/50 transition-all">
                      <p className="text-base sm:text-lg md:text-xl font-bold text-foreground mb-1 sm:mb-2">Crescimento e Expansão</p>
                      <p className="text-primary font-semibold mb-1 sm:mb-2 text-sm sm:text-base">2010</p>
                      <p className="text-muted-foreground text-sm sm:text-base">Expansão das operações e consolidação no mercado brasileiro.</p>
                    </div>
                  </div>

                  <div className="relative pl-12 sm:pl-16 md:pl-20 group">
                    <div className="absolute left-0 flex items-center justify-center w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-full bg-primary/20 border-2 sm:border-4 border-background ring-2 ring-primary group-hover:scale-110 transition-transform">
                      <Award size={14} className="text-primary sm:hidden" />
                      <Award size={16} className="text-primary hidden sm:block md:hidden" />
                      <Award size={20} className="text-primary hidden md:block" />
                    </div>
                    <div className="p-4 sm:p-5 md:p-6 rounded-lg sm:rounded-xl bg-card/50 border border-border hover:border-primary/50 transition-all glow-card">
                      <p className="text-base sm:text-lg md:text-xl font-bold text-foreground mb-1 sm:mb-2">Líderes de Mercado Hoje</p>
                      <p className="text-primary font-semibold mb-1 sm:mb-2 text-sm sm:text-base">Atualmente</p>
                      <p className="text-muted-foreground text-sm sm:text-base">Referência em soluções para circuitos impressos com presença nacional.</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        {/* Pillars Section */}
        <section id="pilares" className="py-12 sm:py-16 md:py-24 px-4 sm:px-6 lg:px-10 scroll-mt-20">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-8 sm:mb-12 md:mb-16">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-black mb-3 sm:mb-4 text-foreground">Nossos Pilares</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
              <div className="group relative p-5 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl bg-card/50 border border-border hover:border-primary/50 transition-all hover:-translate-y-2">
                <div className="absolute inset-0 bg-gradient-to-br from-primary/5 to-transparent rounded-xl sm:rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity"></div>
                <div className="relative">
                  <ShieldCheck size={32} className="text-primary mb-4 sm:mb-6 group-hover:scale-110 transition-transform sm:hidden" />
                  <ShieldCheck size={40} className="text-primary mb-4 sm:mb-6 group-hover:scale-110 transition-transform hidden sm:block" />
                  <h3 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 text-foreground">Confiabilidade</h3>
                  <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
              ...
              <div className="group relative p-5 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl bg-card/50 border border-border hover:border-primary/50 transition-all hover:-translate-y-2">
                <div className="absolute inset-0 bg-gradient-to-br from-primary/5 to-transparent rounded-xl sm:rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity"></div>
                <div className="relative">
                  <Clock size={32} className="text-primary mb-4 sm:mb-6 group-hover:scale-110 transition-transform sm:hidden" />
                  <Clock size={40} className="text-primary mb-4 sm:mb-6 group-hover:scale-110 transition-transform hidden sm:block" />
                  <h3 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 text-foreground">Assiduidade</h3>
                  <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
              ...
              <div className="group relative p-5 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl bg-card/50 border border-border hover:border-primary/50 transition-all hover:-translate-y-2 sm:col-span-2 lg:col-span-1">
                <div className="absolute inset-0 bg-gradient-to-br from-primary/5 to-transparent rounded-xl sm:rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity"></div>
                <div className="relative">
                  <DollarSign size={32} className="text-primary mb-4 sm:mb-6 group-hover:scale-110 transition-transform sm:hidden" />
                  <DollarSign size={40} className="text-primary mb-4 sm:mb-6 group-hover:scale-110 transition-transform hidden sm:block" />
                  <h3 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 text-foreground">Custo Reduzido</h3>
                  <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
        ...
        {/* Products Section */}
        <section id="produtos" className="py-12 sm:py-16 md:py-24 px-4 sm:px-6 lg:px-10 scroll-mt-20">
          <div className="max-w-7xl mx-auto">
            <div className="mb-8 sm:mb-10 md:mb-12">
              <div className="mb-4 sm:mb-6 inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-primary/10 border border-primary/20">
                <span className="text-xs sm:text-sm font-medium text-primary">Catálogo Completo</span>
              </div>
              
              <h2 className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black mb-3 sm:mb-4">
            ...
            <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden glow-card text-center">
              ...
              <div className="relative p-6 sm:p-10 md:p-16">
                <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-black mb-3 sm:mb-4 text-foreground">
                ...
                <a href={whatsappLink} target="_blank" rel="noopener noreferrer">
                  <button className="inline-flex items-center gap-2 sm:gap-3 h-12 sm:h-14 px-6 sm:px-8 bg-primary hover:bg-primary/90 text-primary-foreground text-sm sm:text-base md:text-lg font-bold rounded-lg transition-all shadow-lg hover:shadow-primary/30 hover:scale-105">
        ...
        {/* Contact Section */}
        <section id="contato" className="py-12 sm:py-16 md:py-24 px-4 sm:px-6 lg:px-10 scroll-mt-20">
          <div className="max-w-7xl mx-auto">
            <div className="mb-8 sm:mb-12 md:mb-16 text-center">
              <div className="mb-4 sm:mb-6 inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-primary/10 border border-primary/20">
                <span className="text-xs sm:text-sm font-medium text-primary">Estamos Aqui</span>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 md:gap-12 mb-8 sm:mb-12 md:mb-16">
              <div className="space-y-4 sm:space-y-6 md:space-y-8">
                <div>
                  <h3 className="text-lg sm:text-xl md:text-2xl font-black mb-4 sm:mb-6 md:mb-8 text-foreground text-center lg:text-left">Nossa Localização</h3>
                  
                  <div className="space-y-3 sm:space-y-4 md:space-y-6">
                    <div className="group flex items-start gap-3 sm:gap-4 p-4 sm:p-5 md:p-6 rounded-lg sm:rounded-xl bg-card/50 border border-border hover:border-primary/50 transition-all hover:-translate-y-1">
                      <div className="flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 rounded-lg bg-primary/10 text-primary shrink-0 group-hover:scale-110 transition-transform">
                        <MapPin size={20} className="sm:hidden" />
                        <MapPin size={24} className="hidden sm:block" />
                      </div>
                      <div>
                        <p className="font-bold text-foreground mb-1 sm:mb-2 text-sm sm:text-base">Endereço</p>
                    ...
                    <div className="group flex items-start gap-3 sm:gap-4 p-4 sm:p-5 md:p-6 rounded-lg sm:rounded-xl bg-card/50 border border-border hover:border-primary/50 transition-all hover:-translate-y-1">
                      ...
                      <div>
                        <p className="font-bold text-foreground mb-1 sm:mb-2 text-sm sm:text-base">Telefone</p>
                        <a href="tel:+552125683966" className="text-muted-foreground hover:text-primary transition-colors text-xs sm:text-sm md:text-base">
                          (21) 2568-3966
                        </a>
                      </div>
                    </div>
                    ...
                    <div className="group flex items-start gap-3 sm:gap-4 p-4 sm:p-5 md:p-6 rounded-lg sm:rounded-xl bg-card/50 border border-border hover:border-primary/50 transition-all hover:-translate-y-1">
                      ...
                      <div>
                        <p className="font-bold text-foreground mb-1 sm:mb-2 text-sm sm:text-base">E-mail</p>
                        <a href="mailto:vendas@mbittencourt.com.br" className="text-muted-foreground hover:text-primary transition-colors break-all text-xs sm:text-sm md:text-base">
              ...
              <div className="relative rounded-xl sm:rounded-2xl overflow-hidden glow-card">
                <div className="absolute inset-0 bg-gradient-to-br from-primary/5 to-transparent"></div>
                <div className="relative p-4 sm:p-6 md:p-8 bg-card/80 backdrop-blur-sm border border-border">
                  <h3 className="text-lg sm:text-xl md:text-2xl font-black mb-4 sm:mb-6 text-foreground">Envie uma Mensagem</h3>
        ...
        <section className="py-12 sm:py-16 md:py-24 px-4 sm:px-6 lg:px-10">
          <div className="max-w-7xl mx-auto">
            <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden glow-card">
              <div className="absolute inset-0 bg-gradient-to-br from-primary/20 via-primary/10 to-transparent"></div>
              <div className="relative p-5 sm:p-8 md:p-12 flex flex-col md:flex-row items-center gap-4 sm:gap-6 md:gap-8 text-center md:text-left">
                <div className="flex-1">
                  <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-black mb-2 sm:mb-3 md:mb-4 text-foreground">
                ...
                <a href={whatsappLink} target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto shrink-0">
                  <button className="w-full sm:w-auto flex items-center justify-center gap-2 sm:gap-3 min-w-0 sm:min-w-[200px] md:min-w-[220px] h-12 sm:h-14 px-5 sm:px-8 bg-primary hover:bg-primary/90 text-primary-foreground text-sm sm:text-base md:text-lg font-bold rounded-lg transition-all shadow-lg hover:shadow-primary/30 hover:scale-105">
                    <MessageCircle size={18} className="sm:hidden" />
                    <MessageCircle size={22} className="hidden sm:block" />
